...
async function queryData(query: string, defaultSchema?: string, schemaOnly?: boolean, parameters?: Record<string, { dataType: number; value: any }>) {
    try {
...
async function batchData(query: string, defaultSchema?: string, parameters?: Array<Record<string, { dataType: number; value: any }>>) { 
    try {
...
async function execData(procedure: string, defaultSchema?: string, parameters?: Record<string, { dataType: number; direction?: number; value?: any }>) {  
    try {
